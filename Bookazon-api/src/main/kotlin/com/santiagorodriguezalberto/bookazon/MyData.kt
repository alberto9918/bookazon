...
class MyData(
    ...
    fun initData(){
        ...
        val bibliotecas = listOf(
                ...
                Biblioteca("Biblioteca Infanta Elena", 37.377103, -5.991697)
        )

        val copias = listOf(

                //COPIAS EN LOS CARTEROS
                Copia("DUNE","FRANK HERBERT","Dune es la primera novela de la serie homónima «Dune» de Frank Herbert," +
                ...
                Copia("FAHRENHEIT 451","RAY BRADBURY","Fahrenheit 451: la temperatura a la que el papel se enciende y arde." +
                ...
                Copia("EL MESIAS DE DUNE","FRANK HERBERT","Arrakis, también llamado Dune: un mundo desierto en pos del sueño de convertirse en un paraíso," +
                ...
                Copia("22/11/63","STEPHEN KING","Viajar al pasado nunca ha sido tan creíble." +
